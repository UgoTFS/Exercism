class Triangle {
    ...
    Triangle(double side1, double side2, double side3) throws TriangleException {
        ...
        if (longerSide >= side1 + side2 || longerSide >= side1 + side3 || longerSide >= side2 + side3){
            throw new TriangleException("Provide a valid non-degenerate triangle");
        }
    ...
    boolean isIsosceles() {
        return ((this.side1 == this.side2) || (this.side3 == this.side2) || (this.side1 == this.side3)) ? true : false;
    }
